...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-9446882.198311, 3969306.280806, -9335177.609907, 4039957.488163], maxZoom: 22, minZoom: 1
    })
});


map.getView().fit([-9446882.198311, 3969306.280806, -9335177.609907, 4039957.488163], map.getSize());
